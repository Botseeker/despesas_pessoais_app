...
let bd = new Bd()
  ...
  if(despesa.validarDados()) {
    ...
    $('#modalRegistraDespesa').modal('show')
			...
			//limpas os campos após o cadastro da despesa.
			ano.value = ''
			mes.value = ''
			dia.value = ''
			tipo.value = ''
    ...
    document.getElementById('modal_conteudo').innerHTML = 'Despesa não cadastrada, preencher os campos!'
    document.getElementById('modal_btn').innerHTML = 'Voltar'
